...
export default function PianoVibesScreen() {
  ...
  const pianoSongIds = ["5", "9", "10"]; // Only Piano Vibes songs
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#261f46ff" }}>
      ...
      >
        ...
        <View style={{ alignItems: "center", marginBottom: 30 }}>
          <Image
            source={require("../assets/images/album4.jpg")}
          ...
          >
            Peaceful piano music to calm your mind
          </Text>
        </View>

        {/* Song List */}
        {songs
          .filter((song) => pianoSongIds.includes(song.id))
          .map((song) => (
            <TouchableOpacity
              key={song.id}
