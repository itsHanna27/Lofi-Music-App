...
export default function LofiMixScreen() {
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#261f46ff" }}>
      ...
      <ScrollView
        contentContainerStyle={{
          paddingBottom: currentSong ? NOW_PLAYING_HEIGHT + insets.bottom : 0,
        }}
      >
        {/* Album Art & Info */}
        <View style={{ alignItems: "center", marginBottom: 30 }}>
          ...
          <Text style={{ color: "gray", fontSize: 16, marginTop: 4 }}>
            Chill tracks to relax and study
          </Text>
        </View>

        {/* Song List */}
        {songs
          .filter((song) => lofiSongIds.includes(song.id))
          .map((song) => (
            <TouchableOpacity
              key={song.id}
